...
#ifndef WIRELESSACCESSPOINTMOCK_H
#define WIRELESSACCESSPOINTMOCK_H

#include <QObject>
#include <QString>

class WirelessAccessPointMock : public QObject
{
    Q_OBJECT
...
public:
    WirelessAccessPointMock(QObject *parent = nullptr);
