...
#ifndef WIRELESSSETUPMANAGERMOCK_H
#define WIRELESSSETUPMANAGERMOCK_H
...
class WirelessAccessPointsProxyMock;

class WirelessSetupManagerMock : public BluetoothDeviceMock
{
    Q_OBJECT
    ...
    Q_PROPERTY(WirelessAccessPointsMock *accessPoints READ accessPoints CONSTANT)
    Q_PROPERTY(WirelessAccessPointMock *currentConnection READ currentConnection NOTIFY currentConnectionChanged)
...
public:
    ...
    explicit WirelessSetupManagerMock(QObject *parent = nullptr);
    ...
    WirelessSetupManagerMock::WirelessStatus wirelessStatus() const;
    ...
    WirelessAccessPointMock *currentConnection() const;
...
private:
    ...
    WirelessAccessPointMock *m_currentConnection = nullptr;
