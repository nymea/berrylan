...
class BerryLanBusyIndicator : public QQuickItem
{
    Q_OBJECT
    Q_PROPERTY(QColor color READ color WRITE setColor FINAL)
    Q_PROPERTY(bool running READ isRunning WRITE setRunning FINAL)
    Q_PROPERTY(int penWidth READ penWidth WRITE setPenWidth FINAL)
public:
    explicit BerryLanBusyIndicator(QQuickItem *parent = nullptr);
    QColor color() const;
